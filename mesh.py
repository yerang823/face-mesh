...
#vid_path = '../sber-swap/jtbc_output_mp4/csy_lsj.mp4'
#vid_path = '../sber-swap/csy_lsj.mp4'
...
plt.imshow(background[y1:y2, x1:x2]/255)

plt.imshow(foreground[y1:y2, x1:x2]/255)
...
plt.imshow(outImage[y1:y2, x1:x2]/255)#[50:400,700:1000]/255)

plt.imshow(temp_outImage[y1:y2, x1:x2]/255)#[50:400,700:1000]/255)
...
vc = VideoFileClip('../simswap/jtbc_template/csy.mp4')
vc.audio.write_audiofile('temp_audio.wav') #../simswap/jtbc_template/csy.mp4')#
...
write_video(blending_res, './temp_audio.wav', 30, 'output/o.mp4', slow_write=False)

# !ffmpeg -i temp_audio.wav -i output/o.mp4 -map 0:a -map 1:v ./output/final.mp4
